module.exports = {
  ...
  list: ['mod', 'feat', 'fix', 'chore', 'docs', 'refactor', 'style', 'ci', 'perf', 'test' ],
  maxMessageLength: 64,
  minMessageLength: 3,
  questions: ['type', 'scope', 'subject', 'body', 'breaking', 'issues', 'lerna'],
  scopes: ['' , 'neovim', 'zsh', 'tmux', 'homebrew', '開発ツール'],
  types: {
    chore: {
      description: 'ビルドプロセスや補助ツールの変更（例：gulpの設定変更）',
      emoji: '🤖',
      value: 'chore'
    },
    ci: {
      description: 'CI（継続的インテグレーション）関連の変更。これには、ビルドプロセスの自動化、テストの実行、デプロイプロセスの設定、CIサービス（例：GitHub Actions, Travis CI, GitLab CI）の設定ファイルの追加や更新などが含まれます。',
      emoji: '🎡',
      value: 'ci'
    },
    docs: {
